...
public record FlashcardMarkdownV1Card : FlashcardCard
{
    public const string FormatTag = "MarkdownV1";

    public FlashcardMarkdownV1Card() : base(FormatTag)
    {
    }
	...
	public static bool TryParseFromFile(string content, out FlashcardMarkdownV1Card card)
    {
        card = new();
